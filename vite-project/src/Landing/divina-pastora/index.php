...
<?php
	...
	$_SESSION['ciaOrigen'] = 'divina-pastora';

	$head_title = '💚 Divina Pastora Decesos | Comparativa de Precios y Coberturas';
	$head_descripcion = 'Divina Pastora Seguro Decesos, la tranquilidad de tener tu seguro de decesos en una compañía líder. ¡Entra y Calcula tu Precio Online!';
	$head_keywords = 'divina pastora decesos, seguro decesos divina pastora, seguro de decesos divina pastora';
	$noindex = true;
?>
<html lang="es">
	<?php
