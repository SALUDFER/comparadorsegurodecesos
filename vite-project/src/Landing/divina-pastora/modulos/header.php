...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container">
    <a class="navbar-brand" href="/Landing/divina-pastora/"><img class="logo" src="/images/logotipo.svg" alt="Comparador de Seguros de Decesos" title="Comparador Seguro Decesos"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <form action = '/Landing/comparador' title="Divina Pastora Decesos" method = 'POST'>
						<input type = "hidden" name = "tipo_origen" value = "1">
						<input type = 'hidden' name = 'compa_temp' value = 'divinapastora'>
