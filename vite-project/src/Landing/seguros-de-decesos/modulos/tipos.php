	...
	<div class="container mt-5 mb-5">
		...
		<div class="tipos_landing_flex">
			<div class="tipo_landing d-flex flex-column justify-content-between">
				...
				<br>
				<span>(Contratable hasta los 80 años)</span></h3><hr>
				<p>
			...
			<div class="tipo_landing d-flex flex-column justify-content-between">
				...
				<h3>Seguro de Decesos Prima Única</h3><hr>
				<p>
					<strong>Un sólo pago orientado a personas mayores de 80 años</strong> que por edad no pueden contratar un seguro de decesos convencional o desean hacer un único pago.
				</p>
				<form action="/Landing/comparador" method="POST" class="mt-5">
					<input type = "hidden" name = "tipo_origen" value = "1">
			...
			<div class="tipo_landing d-flex flex-column justify-content-between">
				...
				<h3>Seguro de Repatriación Españoles</h3><hr>
				<p>
			...
			<div class="tipo_landing d-flex flex-column justify-content-between">
				...
				<h3>Seguro de Repatriación Extranjeros</h3><hr>
				<p>
