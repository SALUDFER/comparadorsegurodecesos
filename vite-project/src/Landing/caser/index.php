...
if(!empty($_GET['gcclid']))
	...
	$head_title = '💚 Caser Decesos | Comparativa de Precios y Coberturas';
	$head_descripcion = 'CASER Seguro Decesos, la tranquilidad de tener tu seguro de decesos en una compañía líder. ¡Entra y Calcula tu Precio Online!
	';
	$head_keywords = 'caser decesos, caser seguros decesos, seguros de decesos caser, caser familiar creciente, caser seguros defuncion, calcular seguro de decesos caser';
	$noindex = true;
?>
<html lang="es">
	<?php
