<div class="banner-action py-5">
	<div class="container">
		<div class="row align-items-center justify-content-around">
			<div class="col-md-12 col-lg-6"><h3>¿Quieres conocer el precio de tu Seguro de Decesos en Helvetia?</h3></div>
			...
			<div class="col-md-6 col-lg-4">
				<a href="/Landing/comparador" title="Comparativa Decesos Helvetia"></a>
