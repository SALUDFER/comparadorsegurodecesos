...
<?php
	...
	$head_title = '💚 DKV Protección Familiar | Comparativa de Precios y Coberturas';
	$head_descripcion = 'DKV Seguro Decesos, la tranquilidad de tener tu seguro de decesos en una compañía líder. ¡Entra y Calcula tu Precio Online!';
	$head_keywords = 'dkv decesos, dkv proteccion familiar, dkv seguros decesos, seguro de decesos dkv, dkv proteccion familiar, dkv decesos precios';
	$noindex = true;
?>
<html lang="es">
	<?php
