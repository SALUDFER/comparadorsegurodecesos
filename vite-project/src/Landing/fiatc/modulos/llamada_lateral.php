  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
				...
				<hr>
				<p class="text-center">
					Si necesitas más información sobre nuestros seguros de decesos, facilítanos su número de teléfono y uno de nuestros Agentes se pondrá en contacto contigo.
				</p>
