...
if(!empty($_GET['gcclid']))
	...
	$head_title = '💚 Generali Decesos | Comparativa de Precios y Coberturas';
	$head_descripcion = 'Generali Seguro Decesos, la tranquilidad de tener tu seguro de decesos en una compañía líder. ¡Entra y Calcula tu Precio Online!';
	$head_keywords = 'generali decesos, seguro decesos generali, generali seguros decesos, seguro de decesos generali, generali seguro de decesos, generali seguros decesos prima nivelada';
	$noindex = true;
?>
<html lang="es">
	<?php
...
<!-- End Google Tag Manager (noscript) -->
		...
		include ('modulos/coberturas_extra.php');
