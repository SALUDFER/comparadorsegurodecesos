    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Contrata tu Seguro <span class="letter-spacing">Santalucía Decesos</span> al mejor precio</h1>
          <ul class="fa-ul">
        ...
        <div class="img-banner-cia">
        	...
        	<picture>
  			<source media="(max-width: 576px)" srcset="../images/img-banner-08-S.webp">
  			<source media="(max-width: 767px)" srcset="../images/img-banner-08-M.webp">
  			<img src="../images/img-banner-08.webp" width="230" height="230" class="img-mask" alt="Santalucía Decesos">
  			</picture>
  ...
  <section class="ventajasComparador justify-content-center mb-2 pb-2 pb-md-5">
	...
	<div class="row d-flex pt-3 pt-md-5">
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			...
			<p>Acceso a tratamientos médicos con descuento</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-square-phone"></i></div>
			<p>Teléfono de atención 24 horas a tu disposición</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-people-roof"></i></div>
			<p>Coberturas y ventajas para toda la familia</p>
			</div>
			<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-scale-balanced"></i></div>
			<p>Servicio de asistencia jurídica integral</p>
			</div>
	</div>
	</div>
</section>
