    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Contrata tu Seguro <span>Asisa Decesos</span> al mejor precio</h1>
          <ul class="fa-ul">
        ...
        <div class="img-banner-cia">
        	...
        	<picture>
  			...
  			<img src="../images/img-banner-03.webp" width="230" height="230" class="img-mask" alt="Asisa Decesos">
  			</picture>
        	<div class="logo-cia"><img src="/imagenes/aseguradoras/svg/logo_ASISA.svg" alt="Seguro Decesos Asisa" width="160" height="70"></div>
  ...
  <section class="ventajasComparador justify-content-center mb-2 pb-2 pb-md-5">
	...
	<div class="row d-flex pt-3 pt-md-5">
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			...
			<p>Precio especial por asegurar a toda la familia</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-brands fa-sistrix"></i></div>
			<p>Libertad para elegir el cementerio que quieras en España</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-laptop-medical"></i></div>
			<p>Servicio de videoconsulta médica con especialistas</p>
			</div>
			<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-globe"></i></div>
			<p>Cobertura en todo el mundo</p>
			</div>
	</div>
	</div>
</section>
