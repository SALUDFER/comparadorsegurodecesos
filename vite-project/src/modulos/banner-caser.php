    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Contrata tu Seguro <span>Caser Decesos</span> al mejor precio</h1>
          <ul class="fa-ul">
        ...
        <div class="img-banner-cia">
        	...
        	<picture>
  			<source media="(max-width: 576px)" srcset="../images/img-banner-06-S.webp">
  			<source media="(max-width: 767px)" srcset="../images/img-banner-06-M.webp">
  			<img src="../images/img-banner-06.webp" width="230" height="230" class="img-mask" alt="Caser Decesos">
  			</picture>
        	<div class="logo-cia"><img src="/imagenes/aseguradoras/svg/logo_CASER.svg" alt="Seguro Decesos Caser" width="160" height="70"></div>
