    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Contrata tu Seguro <span>Nortehispana Decesos</span> al mejor precio</h1>
          <ul class="fa-ul">
        ...
        <div class="img-banner-cia">
        	...
        	<picture>
  			...
  			<img src="../images/img-banner-04.webp" width="230" height="230" class="img-mask" alt="Nortehispana Decesos">
  			</picture>
        	<div class="logo-cia"><img src="/imagenes/aseguradoras/svg/logo_NORTEHISPANA.svg" alt="Seguro Decesos Nortehispana" width="160" height="70"></div>
  ...
  <section class="ventajasComparador justify-content-center mb-2 pb-2 pb-md-5">
	...
	<div class="row d-flex pt-3 pt-md-5">
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			...
			<p>Servicio funerario adaptado a cada asegurado</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fas fa-medkit"></i></div>
			<p>Acceso a servicios de salud y bienestar</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-truck-plane"></i></div>
			<p>Traslado desde cualquier parte del mundo</p>
			</div>
			<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fas fa-procedures"></i></div>
			<p>Tratamiento de enfermedades graves en clínica privada</p>
			</div>
	</div>
	</div>
</section>
