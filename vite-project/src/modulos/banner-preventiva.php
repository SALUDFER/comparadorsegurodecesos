    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Contrata tu Seguro <span class="letter-spacing">Preventiva Decesos</span> al mejor precio</h1>
          <ul class="fa-ul">
        ...
        <div class="img-banner-cia">
        	...
        	<picture>
  			...
  			<img src="../images/img-banner-06.webp" width="230" height="230" class="img-mask" alt="Preventiva Decesos">
  			</picture>
        	<div class="logo-cia"><img src="/imagenes/aseguradoras/svg/logo_PREVENTIVA.svg" alt="Seguro Decesos Preventiva" width="160" height="70"></div>
  ...
  <section class="ventajasComparador justify-content-center mb-2 pb-2 pb-md-5">
	...
	<div class="row d-flex pt-3 pt-md-5">
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			...
			<p>Protección para toda la familia</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-map-location-dot"></i></div>
			<p>Servicio de decesos adaptado a los usos y costumbres de tu ciudad</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-phone-volume"></i></div>
			<p>Teléfono de atención 24 horas</p>
			</div>
			<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-regular fa-thumbs-up"></i></div>
			<p>Modalidad de prima a elegir: Natural, nivelada o mixta</p>
			</div>
	</div>
	</div>
</section>
