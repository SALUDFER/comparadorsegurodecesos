    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Contrata tu Seguro <span>Ocaso Decesos</span> al mejor precio</h1>
          <ul class="fa-ul">
        ...
        <div class="img-banner-cia">
        	...
        	<picture>
  			<source media="(max-width: 576px)" srcset="../images/img-banner-05-S.webp">
  			<source media="(max-width: 767px)" srcset="../images/img-banner-05-M.webp">
  			<img src="../images/img-banner-05.webp" width="230" height="230" class="img-mask" alt="Ocaso Decesos">
  			</picture>
        	<div class="logo-cia"><img src="/imagenes/aseguradoras/svg/logo_OCASO.svg" alt="Seguro Decesos Ocaso" width="160" height="70"></div>
  ...
  <section class="ventajasComparador justify-content-center mb-2 pb-2 pb-md-5">
	...
	<div class="row d-flex pt-3 pt-md-5">
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			...
			<p>Descuentos especiales con tu seguro de decesos Ocaso</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-heart"></i></div>
			<p>Asegurados y familiares tendrán atención 24 horas</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-regular fa-star"></i></div>
			<p>Uno de los seguros de decesos más vendidos y con mejores opiniones</p>
			</div>
			<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-earth-americas"></i></div>
			<p>Ocaso ofrece cobertura en todo el mundo</p>
			</div>
	</div>
	</div>
</section>
