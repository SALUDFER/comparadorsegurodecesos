    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Contrata tu Seguro <span>Allianz Decesos</span> al mejor precio</h1>
          <ul class="fa-ul">
        ...
        <div class="img-banner-cia">
        	<div class="anim-svg"><img src="../images/fondo-img-banner.svg" alt="Seguro de decesos" class="bg-banner-cia1" width="550" height="550"/></div>
        	<picture>
  			...
  			<img src="../images/img-banner-02.webp" width="230" height="230" class="img-mask" alt="Allianz Decesos">
  			</picture>
        	<div class="logo-cia"><img src="/imagenes/aseguradoras/svg/logo_ALLIANZ.svg" alt="Seguro Decesos Allianz" width="160" height="70"></div>
  ...
  <section class="ventajasComparador justify-content-center mb-2 pb-2 pb-md-5">
	...
	<div class="row d-flex pt-3 pt-md-5">
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			...
			<p>Allianz cubre todos los gastos, trámites y gestiones del fallecimiento</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-tooth"></i></div>
			<p>Incluye coberturas médicas y dentales</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-person-cane"></i></div>
			<p>Opción de prima única para los mayores de 65 años</p>
			</div>
			<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-plane-up"></i></div>
			<p>Traslado nacional e internacional de los restos</p>
			</div>
	</div>
	</div>
</section>
