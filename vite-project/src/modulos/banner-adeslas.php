    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Contrata tu Seguro <span>Adeslas Decesos</span> al mejor precio</h1>
          <ul class="fa-ul">
          ...
          <form action="/comparador-compania" method="POST">
						<input type="hidden" name="compa_temp" value="adeslas">
        ...
        <div class="img-banner-cia">
        	...
        	<!--<picture>
  			<source media="(max-width: 576px)" srcset="../images/img-banner-01-S.webp">
  			<source media="(max-width: 767px)" srcset="../images/img-banner-01-M.webp">
  			<img src="../images/img-banner-01.webp" width="230" height="230" class="img-mask" alt="Adeslas Decesos" loading="lazy">
  			</picture>  	-->
        	<picture>
  <source media="(max-width: 576px)" srcset="../images/img-banner-01-S.webp">
  <source media="(max-width: 767px)" srcset="../images/img-banner-01-M.webp">
  <source srcset="../images/img-banner-01.webp">
  <img src="../images/img-banner-01.webp" width="230" height="230" class="img-mask" alt="Adeslas Decesos" sizes="(max-width: 576px) 100vw, (max-width: 767px) 50vw, 230px">
</picture>
        	
        	
        	<div class="logo-cia"><img src="/imagenes/aseguradoras/svg/logo_ADESLAS.svg" alt="Seguro Decesos Adeslas" width="160" height="70"></div>
  ...
  <section class="ventajasComparador justify-content-center mb-2 pb-2 pb-md-5">
	...
	<div class="row d-flex pt-3 pt-md-5">
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			...
			<p>Gestión de gastos de sepelio en cualquier lugar del mundo.</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-truck-plane"></i></div>
			<p>Traslado nacional e internacional y libre elección de cementerio.</p>
			</div>
		<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-regular fa-file-lines"></i></div>
			<p>Servicio de gestoría para los trámites jurídico-administrativos. </p>
			</div>
			<div class="col-sm-6 col-md-3 d-inline-flex align-items-start">
			<div class="icon"><i class="fa-solid fa-earth-americas"></i></div>
			<p>Asistencia en viaje para todos los asistentes de la unidad familiar.</p>
			</div>
	</div>
	</div>
</section>
