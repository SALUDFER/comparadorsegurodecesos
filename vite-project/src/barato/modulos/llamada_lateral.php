<div id="llamadafixed" class="llamada-gratis-fixed text-center">
	...
	<p class="blanco text-center">Llámenos al <a href="tel:+34900264083" title="Llamar al 900 264 083" class="tel_num">900 264 083</a></p>
	<hr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content text-center">
      ...
      <p class="text-center llamada_grande">Teléfono de contacto<br>
      	<a href="tel:+34900264083" title="Llamar a 900 264 083" class="verde llamada-modal">900 264 083</a>
      	</p>
